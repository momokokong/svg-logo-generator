class Shape {
  ...
  getSVGContent() {
    return this.getSVGShape() + this.getSVGText(); 
  }

  render(){
    return this.svgOpeningTag + this.getSVGContent() + this.svgClosingTag;
  }
}
