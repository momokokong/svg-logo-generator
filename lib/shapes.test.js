...
// Shape Class tests
// Given it's the abstraction class that the other shapes depend on, need to make sure each
// the properties and methods are functioning as intended.
// Two chunks of tests - properties and methods
//   Properties - make sure the constructor works as intended and the global consts are good
//   Methods - make sure the methods are returning the right values or providing the reminders
...
// Circle, Rectangle, Triangle Classes tests
// Goal is to test the properties that are affected by OOP machanisms.
// Two chunks of tests - inherited properties and polymorphed methods and dependant methods
